...
from app.routers import auth, influencers, brands, portfolio, reviews, campaigns, deliverables, applications, content, assignments, favorites, notifications, messages, pricing, dashboard, ai
...
app.include_router(favorites.router, prefix="/api/v1/favorites")
